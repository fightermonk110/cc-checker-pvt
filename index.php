...
<html class="loading"><head>
    ...
    <title>『ᝯׁhׁׅ֮ꪱׁׅtׁׅꪀׁׅᧁׁꫀׁׅܻ 』【𝙶𝚂】ꪜ🇲🇲</title>
    ...
    <div class="uk-background-default uk-border-rounded uk-box-shadow-small">
      <div class="uk-container uk-container-xsmall uk-padding-large" style="width:100%;padding:0px">
        <article class="uk-article">
          ...
          <h1 class="uk-article-title">『ᝯׁhׁׅ֮ꪱׁׅtׁׅꪀׁׅᧁׁꫀׁׅܻ 』【𝙶𝚂】ꪜ🇲🇲</h1>            	  	  
          ...
          <div class="uk-article-content">
            ...
            <div class="uk-form-stacked uk-margin-medium-top">
              ...
              <div class="uk-margin-bottom">
				...
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/razorpay.php"> SITE BASED API 5.99$</option>
	...
	<div class="uk-container uk-container-small">
		<div>
			<ul class="uk-subnav uk-flex-center">
				...
				<li><a href="https://t.me/Ownerxxxxx">Support</a></li>
				<li><a href="https://t.me/Ownerxxxxx">Contact</a></li>
			</ul>
		</div>

		<div class="uk-margin-medium uk-text-small uk-link-muted">Crafted by <a href="t.me/Ownerxxxxx">『ᝯׁhׁׅ֮ꪱׁׅtׁׅꪀׁׅᧁׁꫀׁׅܻ 』【𝙶𝚂】ꪜ🇲🇲</a></div>
	</div>
